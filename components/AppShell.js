            ...
            {active === "eye" ? (
              <>
                ...
                <section className="card">
                  ...
                  <div className="small">
                    Multi-update through the day. Hub shows only progress bars (logic later).
                  </div>
                  <div className="grid2">
                ...
                <section className="card">
                  ...
                  <div className="small">
                    Hub auto-populates from: Moments, Roid Boy, and P.S. once entries are completed.
                  </div>
                ...
                <section className="card">
                  ...
                  <div className="small">
                    Hub auto-populates from the Summation tab once completed.
                  </div>
                </section>
              </>
            ) : (
              <>
                <div className="hubTitle">{active.toUpperCase()}</div>
                <section className="card">
                  <div className="cardHead">COMING ONLINE</div>
                  <div className="small">This section is wired in the canon shell; view content will be dropped in next.</div>
                </section>
              </>
            )}
          </main>
